...
$mcImageManagerConfig['general.language']            = "sk"; // en, sv
...
$mcImageManagerConfig['filesystem.rootpath']                   = $_SERVER['DOCUMENT_ROOT'] . '/uploaded/files'; // absolute or relative from this script path, required.
...
$mcImageManagerConfig['upload.use_flash']               = true;
