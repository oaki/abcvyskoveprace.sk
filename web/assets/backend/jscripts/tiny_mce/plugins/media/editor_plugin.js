        ...
        init           : function(n, j) {
            ...
            function r(i, n) {
                ...
                if (J) {
                    ...
                    N = "";
                    L = p.getParam("flash_video_player_flashvars", {url : "$url", poster : "$poster"});
                    ...
                    K = p.getParam("flash_video_player_params", {allowfullscreen : true, allowscriptaccess : true});
