(function(e) {
    ...
    var t = function(e, i, a) {
        ...
        if (o.onerror = i, o.onload = function() {
            ...
            }, t.isInstanceOf("Blob", e) || t.isInstanceOf("File", e))n = r = t.createObjectURL(e), o._type = e.type; else {
    ...
    t.isInstanceOf = function(e, t) {
        ...
        var i = e.getContext("2d"), a = e.width, n = e.height;
        ...
        i = i || {};
        var a, n, r, o, s, d, l, c = document.createElement("canvas"), u = e.getContext || (i.canvas || i.crop || i.orientation) && c.getContext, g = e.width, f = e.height, h = g, m = f, p = 0, S = 0, x = 0, y = 0;
    ...
    if (window.navigator && window.navigator.platform && /iP(hone|od|ad)/.test(window.navigator.platform)) {
        ...
        e.detectSubsampling = function(e) {
            ...
            var i, a, n, r, o, s = document.createElement("canvas"), d = s.getContext("2d");
            ...
            if ("image/jpeg" === a._type) {
                var g, f, h, m, p = i.getContext("2d"), S = document.createElement("canvas"), x = 1024, y = S.getContext("2d");
